    ...
    <>
      {selectedChat ?( 
        <>
            ...
            <Box id='chatRoom' display='flex' flexDir='column' justifyContent='flex-end' p={3} bg='#E8E8E8' w='100%' h='100%' borderRadius='lg' overflow='hidden' >
                  {/* //  Message here */}
                ...
                <FormControl onKeyDown={sendMessage} isRequired mt={3}>
                    ...
                    <Input variant='filled' bg='#E0E0E0' onChange={typingHandler} value={newMessage} placeholder='Enter Message..'/>
                </FormControl>
            </Box>
        </>
      ):(
